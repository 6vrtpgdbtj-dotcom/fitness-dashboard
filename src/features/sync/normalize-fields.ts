...
const categories: Record<string, string> = { 신규: "new", 첫등록: "new", new: "new", 재등록: "renewal", 연장: "renewal", re: "renewal", renewal: "renewal", 필드: "field", field: "field", 오티: "ot", ot: "ot", 추가: "additional", 추가등록: "additional", additional: "additional", 미분류: "uncategorized", 미확인: "uncategorized", unknown: "uncategorized", uncategorized: "uncategorized" };
