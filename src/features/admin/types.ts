...
export type ReviewRecord = { id: string; domain: MappingDomain; tab_title: string; record_status: string; name?: string | null; issues: { field: string; code: string; message: string; severity?: "warning"; candidates?: { memberId: string; score: number; reasons: string[] }[] }[]; source_fields: { sourceHeader: string; field: string | null }[]; [key: string]: unknown };
